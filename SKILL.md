...
YES/NO bets on prediction markets. Pool splits proportionally among winners.
...
- Price prediction bets: 5 DEM per bet (winner takes pool)
- Free testnet DEM: https://faucet.demos.sh/
